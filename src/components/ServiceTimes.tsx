    ...
    <section ref={ref} id="service-times" className="section section-cream">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-16 reveal">
          <span className="label-tag mb-4 block">Welcome Home</span>
          <h2 className="heading-lg mb-4">Weekly Service Times</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-3 space-y-4">
              ...
              return (
                <div key={service.id}
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="heading-sm text-[#1a1625] group-hover:text-[#6b5c93] transition-colors">{service.title}</h3>
            ...
            <div className="card bg-gradient-to-br from-[#6b5c93]/5 to-transparent border-[#6b5c93]/10 reveal reveal-left reveal-delay-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <span className="label-tag mb-2 block">Need Prayer?</span>
                  <p className="text-sm text-[#6b6580]">Our prayer circles are available around the clock.</p>
                </div>
          ...
          <div className="lg:col-span-2 reveal-blur reveal-delay-2">
            ...
            <div className="mt-4 flex justify-between items-center px-1">
              <span className="text-[0.65rem] font-medium text-[#6b6580] tracking-wider">Main Sanctuary</span>
              <span className="text-[0.65rem] font-medium text-[#6b5c93] tracking-wider">Kalyanipura, KP 45678</span>
            </div>
          </div>
        </div>
      </div>
